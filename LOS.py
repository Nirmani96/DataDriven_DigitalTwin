...
start_ts    = forecast_ts - pd.Timedelta(weeks=12)  # 12 weeks lookback window
...
if len(all_los_records) == 0:
    raise ValueError("No LOS data found in the last 12 weeks!")
...
print(
    f"Weekday-specific LOS GMM parameters (last 12 weeks) saved to:\n"
    f"{output_path}"
)
